...
const DATAOPERATIONLIST: DataOperationDef[] = [
  ...
  {
    'uid':'getEquivalents',
    'url':'v1/product-data/products/{0}/equivalents',
    'method':'GET',
    'typeName':'Empiria.Trade.Product',
    'typeOperation':'getList'
  },
  {
    'uid':'getProductCategories',
    'url':'v1/product-data/product-categories',
    'method':'GET',
    'typeName':'Empiria.Products.ProductCategory',
    'typeOperation':'getList'
  },
  {
    'uid':'getProductSubcategories',
    'url':'v1/product-data/product-categories/{0}/sub-categories',
    'method':'GET',
    'typeName':'Empiria.Products.ProductSubcategory',
    'typeOperation':'getList'
  },
  {
    'uid':'getProductTerms',
    'url':'v1/product-data/product-sub-categories/{0}/product-terms',
    'method':'GET',
    'typeName':'Empiria.Products.ProductTerm',
    'typeOperation':'getList'
  },
  {
    'uid':'getBrands',
    'url':'v1/product-data/brands',
    'method':'GET',
    'typeName':'Empiria.Products.Brand',
    'typeOperation':'getList'
  },
  {
    'uid':'getTraders',
